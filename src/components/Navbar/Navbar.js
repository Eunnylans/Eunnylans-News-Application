      ...
      <Toolbar sx={{ justifyContent: "space-between" }}>
        ...
        <Box sx={{ display: { xs: "block", sm: "none" } }}>
          <IconButton
            ...
            color="inherit"
            aria-label="menu"
            onClick={anchorEl ? handleMenuClose : handleMenuOpen} // Toggle between open and close
          >
            {anchorEl ? <CloseIcon /> : <MenuIcon />} {/* Conditional rendering */}
          </IconButton>
          <Menu
            anchorEl={anchorEl}
          ...
          >
            <MenuItem>
              <FormControl variant="outlined" sx={{ minWidth: 315 }}>
            ...
            <MenuItem>
              <Button
                ...
                sx={{ color: "white", height: "56px", backgroundColor: "#007BFF" }}
              >
                Apply Filters
              </Button>
            </MenuItem>
